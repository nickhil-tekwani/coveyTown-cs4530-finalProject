    ...
    conversationAreas.forEach(eachNewArea => {
      ...
      if (existingArea) {
        ...
        const updateListener = {
          ...
          /*
          We may end up just storing queue info in the conversation areas and using the existing conversation area context/hook?
          */
          onQueueChange: (newQueue: Queue) => {
            if (newQueue) {
              existingArea.queue = newQueue;
            } else {
              existingArea.queue = new Queue([], []);
            }
          }
        ...
        updateListener.onQueueChange(eachNewArea.queue);
      }
    });
